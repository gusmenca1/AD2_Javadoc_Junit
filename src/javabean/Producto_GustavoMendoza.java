...
public class Producto_GustavoMendoza {
     ...
     * Se permite la entrada de double con el fin de practicar el lanzamiento de una excepción.
     * Si cualquiera de los números es cero, el resultado será cero.
     * @param numero1 El primer número double.
     * @param numero2 El segundo número entero.
     * @return El producto de numero1 y numero2. Será cero si alguno de los números es cero.
     * @throws IllegalArgumentException si el resultado de la multiplicación causa un desbordamiento.
     */
    public int multiplicarEnteros(int numero1, int numero2) {
        long result = (long) numero1 * (long) numero2;
        if (result > Integer.MAX_VALUE || result < Integer.MIN_VALUE) {
            throw new IllegalArgumentException("Multiplicación fuera de los límites de un entero.");
        }
        return (int) result;
    }
    ...
    public static void menu(){
        ...
        char opcion;
        Producto_GustavoMendoza producto = new Producto_GustavoMendoza();  // Crear una instancia de la clase
